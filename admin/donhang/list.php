    ...
    <div class="row form-content" >
        <table>
            ...
            foreach ($listbill as $bill) {
                ...
                <td class="text-center"><a href="'.$suabill.'"><input type="button" value="Sửa" class="btn-update"></a>
                <a href="' . $xoabill . '" class="deleteLink" data-id="' . $id . '"><input type="button" value="Hủy" class="btn-delete"></a>
                <a href="'.$chitietbill.'"><input type="button" value="Chi tiết" class="btn-detail"></a></td>
            </tr>';
            }
            ?>
        </table>
