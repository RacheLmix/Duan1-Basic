            ...
            <div class="container">
                <div class="breadcrumb-content">
                    <ul>
                        ...
                        <li class="active">Chi tiết đơn hàng DH-<?= $id?></li>
                    </ul>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="billing-information-wrapper">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="billing-info">
                                                            <label>Email</label>
                                                            <input type="email" value="<?=$email_dh?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="billing-info">
                                                            <label>Tên người đặt</label>
                                                            <input type="text" value="<?=$tenkh?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="billing-info">
                                                            <label>Địa chỉ</label>
                                                            <input type="text" value="<?=$dc_dh?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="billing-info">
                                                            <label>Số điện thoại</label>
                                                            <input type="text" value="<?=$sdt_dh?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="billing-info">
                                                            <label>Ngày đặt hàng</label>
                                                            <input type="text" value="<?=$ngaydathang?>"readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="billing-info">
                                                            <label>Đơn giá</label>
                                                            <input type="text" value="<?=number_format($tong, 0, ",", ".")?> đ"readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
